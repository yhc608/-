...
exports.logger = winston_1.default.createLogger({
    ...
    defaultMeta: { service: 'eduglobe-api' },
    transports: [
        new winston_1.default.transports.File({ filename: logDir.replace('.log', '-error.log'), level: 'error' }),
        new winston_1.default.transports.File({ filename: logDir }),
    ],
});
// 开发环境下，同时输出到控制台
